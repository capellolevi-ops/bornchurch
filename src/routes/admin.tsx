...
const crudSections: CrudSection[] = [
  ...
  },
  {
    ...
    titleField: "name",
    fields: [
      { name: "name", label: "Nome do artista", type: "text" },
      { name: "slug", label: "Endereço na web (ex.: born-worship)", type: "text" },
      { name: "photo_url", label: "URL da foto", type: "text" },
  ...
  },
  {
    ...
    fields: [
      { name: "title", label: "Título", type: "text" },
      { name: "slug", label: "Endereço na web", type: "text" },
      { name: "artist_id", label: "ID do artista", type: "text" },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "slug", label: "Endereço na web", type: "text" },
      { name: "artist_id", label: "ID do artista", type: "text" },
      { name: "album_id", label: "ID do álbum (opcional)", type: "text" },
      { name: "cover_url", label: "URL da capa", type: "text" },
      { name: "audio_url", label: "URL do arquivo de áudio (opcional)", type: "text" },
      ...
      { name: "duration_seconds", label: "Duração (segundos)", type: "number" },
      {
        ...
        options: [
          ...
          { value: "sermon", label: "Mensagem" },
          { value: "podcast", label: "Podcast" },
        ],
      },
      { name: "track_number", label: "Faixa nº", type: "number" },
      { name: "released_on", label: "Lançamento", type: "date" },
      { name: "lyrics", label: "Letra", type: "textarea" },
      { name: "credits", label: "Créditos", type: "textarea" },
      { name: "description", label: "Descrição", type: "textarea" },
      { name: "published", label: "Publicada", type: "bool" },
    ],
  },
  {
    ...
    fields: [
      ...
      { name: "description", label: "Descrição", type: "textarea" },
      { name: "cover_url", label: "URL da capa", type: "text" },
      { name: "is_public", label: "Pública", type: "bool" },
      { name: "is_collaborative", label: "Colaborativa", type: "bool" },
      { name: "featured", label: "Destaque na home da música", type: "bool" },
    ],
  },
  {
    id: "admin_users",
